		...
		<>
			...
			<div className="overlay-wrapper" ref={overlay}>
				...
				>
					...
					<div className="w-fit button-default backdrop-blur-3xl backdrop-brightness-110 rounded-full p-1 mx-auto pointer-events-auto !bg-black/20">
						<button
							className={`${
								!interior
									? "text-black/50 bg-white"
									: "text-white"
							} px-3 text-xs font-medium cursor-pointer rounded-full py-1.5`}
				...
				<div
					className={`fixed top-0 left-0 w-screen bg-gradient-to-b from-black/30 to-transparent h-20 ${
						interior ? "z-[9999]" : "z-0"
					}`}
				></div>
				<div
					className={`fixed bottom-0 left-0 w-screen bg-gradient-to-b from-transparent to-black/30 z-0 h-20 ${
						interior ? "z-[9999]" : "z-0"
					}`}
				></div>
			</div>
